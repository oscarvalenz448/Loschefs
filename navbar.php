                    ...
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                <li><a title="Dashboard v.1" href="index.php"><span class="mini-sub-pro">Dashboard Gral</span></a></li>
                                <li><a title="Dashboard v.2" href="inventarioAlimentos.php"><span class="mini-sub-pro">Dashboard Alimentos</span></a></li>
                                <li><a title="Dashboard v.3" href="inventarioBebidas.php"><span class="mini-sub-pro">Dashboard Bebidas</span></a></li>
                                <li><a title="Analytics" href="analyticsMonth.php"><span class="mini-sub-pro">Estadistícas</span></a></li>
                                <li><a title="Widgets" href="inventarioGral.php"><span class="mini-sub-pro">Inventario Gral</span></a></li>
                            </ul>
                        </li>
                        <!--li>
                                    ...
                                    <ul class="mobile-menu-nav">
                                        <li><a data-toggle="collapse" data-target="#Charts" href="#">Home <span class="admin-project-icon edu-icon edu-down-arrow"></span></a>
                                            <ul class="collapse dropdown-header-top">
                                                ...
                                                <li><a href="analyticsMonth.php">Analytics</a></li>
